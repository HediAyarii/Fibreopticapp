...
async function testFinalCarburantFix() {
  try {
    console.log('🧪 Test final de la correction du carburant...')
    ...
    // 1. Test de la requête complète avec différentes approches
    console.log('\n🔧 1. Test de la requête complète:')
...
if (require.main === module) {
  testFinalCarburantFix()
}

module.exports = { testFinalCarburantFix }
