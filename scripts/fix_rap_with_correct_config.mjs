...
// Configuration de la base de données (même que dans lib/database.ts)
const pool = new Pool({
...
async function fixRapWithCorrectConfig() {
  try {
    console.log('🔧 Correction de la formule RAP avec la configuration correcte...')
