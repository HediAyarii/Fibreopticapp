...
async function checkAdminUser() {
  console.log('🔍 Vérification de l\'utilisateur admin@fibertech.com...')
  
  try {
    // Récupérer les permissions de l'utilisateur admin
    ...
    if (result.rows.length === 0) {
      console.log('❌ Utilisateur admin@fibertech.com non trouvé')
      return
    }
