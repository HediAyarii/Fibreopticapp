// Script de test pour vérifier les fonctionnalités des employés
const BASE_URL = 'http://localhost:3000';

async function testEmployeesFunctionality() {
  console.log('🔍 Test des fonctionnalités des employés...\n');
...
async function main() {
  await testEmployeesFunctionality();
}
