// Script de test pour vérifier les fonctionnalités des pénalités simplifiées
const BASE_URL = 'http://localhost:3000';

async function testSimplifiedPenalties() {
  console.log('🔍 Test des fonctionnalités des pénalités simplifiées...\n');
  ...
  try {
    ...
    // 2. Test d'ajout d'une pénalité (sans numéro - généré automatiquement)
    ...
    const testPenalty = {
      ...
      motif: 'Retard injustifié de 30 minutes',
    ...
    if (addResponse.ok) {
      ...
      // 3. Test de modification de la pénalité
      console.log('\n3. Test de modification de la pénalité...');
      const updateData = {
        montant: 50.00,
        statut: 'suspendue',
    ...
    console.log('   ✅ Modification de pénalité');
